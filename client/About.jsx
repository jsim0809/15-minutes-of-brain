...
const About = () => (
  <span>
    ...
    <p className="text-left"><span className="font-weight-bolder">15 Minutes of Brain</span> is designed to fill those gaps with growth and learning. 
    ...
    <p className="text-left">Watch enough videos, and you might get a surprise.</p>
